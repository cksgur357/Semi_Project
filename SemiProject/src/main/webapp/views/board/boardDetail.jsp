<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"  import="web.board.model.vo.*, java.util.*"%>
...
<style>
	/*body {
		background: url("/semi/resources/images/community.jpg") no-repeat;
		...
		<div class="tableArea">
				<table align="center" width="800px">
					...
					<tr>
						<td>첨부파일 </td>
						<td colspan="5">
							<a href="/semi/resources/boardUploadFiles/<%=b.getBoardfile() %>" download>
							<%=b.getBoardfile() %>
							</a>
						</td>
					</tr>
